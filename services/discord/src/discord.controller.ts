...
export class DiscordController {
  ...
  @MessagePattern(DISCORD_SEND_GAME_CHAT_MESSAGE_WEBHOOK_CMD)
  ...
  @MessagePattern(DISCORD_SEND_PLAYER_CONNECT_MESSAGE_WEBHOOK_CMD)
  ...
  @MessagePattern(DISCORD_SEND_PLAYER_DISCONNECT_MESSAGE_WEBHOOK_CMD)
